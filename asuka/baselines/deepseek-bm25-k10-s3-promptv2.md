...
| 上下文片数（mean） | 10.0 |
| 生成 token（mean，prompt+completion） | 2186.6 |
| 总 token | 157434 |
| 每答到一个要点的字符数 | 618.9 |
...
|---|---|---|---|---|---|
| simple | 24 | 0.4194 | 0.0000 | 0.0000 | 2032.9 |
| medium | 24 | 0.0521 | 0.0000 | 0.0000 | 2257.7 |
| hard | 24 | 0.0083 | 0.0000 | 0.0000 | 2269.2 |

## 一个要点都没答到的题（14）

- `r-simple-05` (simple) What does ZADD return, and how do the CH and INCR options change the r
  - 缺：默认返回**新增**成员数
  - 缺：CH ⇒ 新增或更新
  - 缺：INCR ⇒ 返回更新后的分数
  - 缺：冲突中止 ⇒ nil
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| `r-simple-01` | simple | 0/3 | 0.50 | 136 | 993 | 1693 | 0 | 1889 | 1 条 | 3/12 | — |
| `r-simple-02` | simple | 0/3 | 0.80 | 203 | 1002 | 1735 | 0 | 2029 | 1 条 | 3/3 | — |
| `r-simple-03` | simple | 0/3 | 0.22 | 212 | 2222 | 2697 | 0 | 1870 | 2 条 | 6/6 | — |
| `r-simple-04` | simple | 0/3 | 0.50 | 292 | 1092 | 1736 | 0 | 1849 | 2 条 | 3/3 | — |
| `r-simple-05` | simple | 0/3 | 0.00 | 452 | 1713 | 2410 | 0 | 2593 | 3 条 | 6/6 | — |
| `r-simple-06` | simple | 0/3 | 0.33 | 235 | 1391 | 2050 | 0 | 2299 | 3 条 | 3/3 | — |
| `r-simple-07` | simple | 0/3 | 0.33 | 350 | 1485 | 2102 | 0 | 2114 | 2 条 | 3/3 | — |
| `r-simple-08` | simple | 0/3 | 0.67 | 177 | 1333 | 1839 | 0 | 2016 | 2 条 | 3/3 | — |
| `r-medium-01` | medium | 0/3 | 0.00 | 141 | 1457 | 2105 | 0 | 2170 | 1 条 | 3/12 | — |
| `r-medium-02` | medium | 0/3 | 0.17 | 432 | 1640 | 2267 | 0 | 2263 | 2 条 | 6/6 | — |
| `r-medium-03` | medium | 0/3 | 0.00 | 266 | 1582 | 2505 | 0 | 2420 | 3 条 | 0/18 | — |
| `r-medium-04` | medium | 0/3 | 0.25 | 238 | 1601 | 2323 | 0 | 2353 | 2 条 | 6/12 | — |
| `r-medium-05` | medium | 0/3 | 0.00 | 146 | 1467 | 2325 | 0 | 2535 | 10 条 | 0/12 | — |
| `r-medium-06` | medium | 0/3 | 0.00 | 245 | 1244 | 2013 | 0 | 2100 | 1 条 | 0/15 | — |
| `r-medium-07` | medium | 0/3 | 0.00 | 127 | 1549 | 2135 | 0 | 2094 | 2 条 | 6/6 | — |
| `r-medium-08` | medium | 0/3 | 0.00 | 597 | 1583 | 2387 | 0 | 3251 | 4 条 | 6/12 | — |
| `r-hard-01` | hard | 0/3 | 0.00 | 1146 | 1589 | 2740 | 0 | 4146 | 6 条 | 16/36 | — |
| `r-hard-02` | hard | 0/3 | 0.00 | 426 | 2101 | 2896 | 0 | 2891 | 7 条 | 0/15 | — |
| `r-hard-03` | hard | 0/3 | 0.00 | 373 | 1398 | 2171 | 0 | 2664 | 4 条 | 9/9 | — |
| `r-hard-04` | hard | 0/3 | 0.00 | 340 | 1718 | 2556 | 0 | 2637 | 2 条 | 3/15 | — |
| `r-hard-05` | hard | 0/3 | 0.00 | 786 | 1682 | 2630 | 0 | 3795 | 7 条 | 0/12 | — |
| `r-hard-06` | hard | 0/3 | 0.00 | 372 | 1320 | 2014 | 0 | 2918 | 2 条 | 3/21 | — |
| `r-hard-07` | hard | 0/3 | 0.07 | 375 | 1166 | 1271 | 0 | 3927 | — | — | ! |
| `r-hard-08` | hard | 0/3 | 0.00 | 383 | 1178 | 1872 | 0 | 2261 | 2 条 | 3/12 | — |
