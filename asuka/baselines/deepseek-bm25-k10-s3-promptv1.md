...
| 上下文片数（mean） | 10.0 |
| 生成 token（mean，prompt+completion） | 2066.0 |
| 总 token | 148752 |
| 每答到一个要点的字符数 | 565.9 |

| 总成本 | $0.0516 |

⚠️ 有 **2** 次生成**报错**（不是答错）。见逐题明细的 `err` 列。
...
⚠️ 有 **2** 条样本**没有自述引用**，它们**不在**任何引用分母里（分母是 70 条）。『没自述』不等于『没引用』—— 所以这里既不算 0 也不算 1。
...
|---|---|---|---|---|---|
| simple | 24 | 0.4104 | 0.0833 | 0.1250 | 1810.4 |
| medium | 24 | 0.1562 | 0.0000 | 0.0000 | 2171.0 |
| hard | 24 | 0.0000 | 0.0000 | 0.0000 | 2216.6 |
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| `r-simple-01` | simple | 0/3 | 0.50 | 148 | 993 | 1612 | 0 | 1778 | 1 条 | 3/12 | — |
| `r-simple-02` | simple | 0/3 | 0.53 | 162 | 1002 | 1107 | 0 | 2955 | 0 条 | 2/2 | ! |
| `r-simple-03` | simple | 0/3 | 0.00 | 118 | 2222 | 2591 | 0 | 1836 | 2 条 | 6/6 | — |
| `r-simple-04` | simple | 0/3 | 0.33 | 93 | 1092 | 1066 | 0 | 2955 | 0 条 | 2/2 | ! |
| `r-simple-05` | simple | 2/3 | 0.92 | 1248 | 1713 | 2412 | 0 | 2766 | 3 条 | 6/6 | — |
| `r-simple-06` | simple | 0/3 | 0.00 | 222 | 1391 | 1961 | 0 | 2432 | 3 条 | 3/3 | — |
| `r-simple-07` | simple | 0/3 | 0.33 | 233 | 1485 | 1985 | 0 | 1889 | 2 条 | 3/3 | — |
| `r-simple-08` | simple | 0/3 | 0.67 | 120 | 1333 | 1746 | 0 | 1736 | 2 条 | 3/3 | — |
| `r-medium-01` | medium | 0/3 | 0.50 | 264 | 1457 | 2008 | 0 | 1921 | 1 条 | 3/12 | — |
| `r-medium-02` | medium | 0/3 | 0.50 | 824 | 1640 | 2232 | 0 | 2491 | 2 条 | 6/6 | — |
| `r-medium-03` | medium | 0/3 | 0.17 | 495 | 1582 | 2438 | 0 | 2456 | 3 条 | 0/18 | — |
| `r-medium-04` | medium | 0/3 | 0.08 | 344 | 1601 | 2219 | 0 | 2071 | 2 条 | 6/12 | — |
| `r-medium-05` | medium | 0/3 | 0.00 | 218 | 1467 | 2264 | 0 | 2507 | 10 条 | 0/12 | — |
| `r-medium-06` | medium | 0/3 | 0.00 | 128 | 1244 | 1866 | 0 | 2142 | 1 条 | 0/15 | — |
| `r-medium-07` | medium | 0/3 | 0.00 | 147 | 1549 | 2063 | 0 | 2035 | 2 条 | 6/6 | — |
| `r-medium-08` | medium | 0/3 | 0.00 | 528 | 1583 | 2277 | 0 | 2954 | 4 条 | 6/12 | — |
| `r-hard-01` | hard | 0/3 | 0.00 | 1279 | 1589 | 2677 | 0 | 4387 | 8 条 | 21/36 | — |
| `r-hard-02` | hard | 0/3 | 0.00 | 148 | 2101 | 2598 | 0 | 2170 | 0 条 | 0/15 | — |
| `r-hard-03` | hard | 0/3 | 0.00 | 569 | 1398 | 2100 | 0 | 2748 | 5 条 | 9/9 | — |
| `r-hard-04` | hard | 0/3 | 0.00 | 462 | 1718 | 2546 | 0 | 2815 | 4 条 | 3/15 | — |
| `r-hard-05` | hard | 0/3 | 0.00 | 329 | 1682 | 2277 | 0 | 2604 | 5 条 | 0/12 | — |
| `r-hard-06` | hard | 0/3 | 0.00 | 672 | 1320 | 2087 | 0 | 3148 | 3 条 | 3/21 | — |
| `r-hard-07` | hard | 0/3 | 0.00 | 566 | 1166 | 1697 | 0 | 2449 | 4 条 | 6/12 | — |
| `r-hard-08` | hard | 0/3 | 0.00 | 298 | 1178 | 1750 | 0 | 2051 | 2 条 | 3/12 | — |
